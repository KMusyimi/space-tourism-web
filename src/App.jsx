...
const router = createBrowserRouter(createRoutesFromElements(<Route path={'/'} element={<Layout/>}>
    ...
    <Route path={'destinations'} element={<DestinationLayout/>}>
        <Route index element={<Destination/>} loader={DestinationLoader}/>
        <Route path={':id'} element={<Destination/>} loader={DestinationLoader}/>
    </Route>
    <Route path={'crews'} element={<CrewLayout/>}>
        <Route index element={<Crew/>} loader={crewLoader}/>
        <Route path={':id'} element={<Crew/>} loader={crewLoader}/>
    </Route>
    <Route path={'technology'} element={<TechLayout/>}>
        <Route index element={<Technology/>} loader={TechLoader}/>
        <Route path={':id'} element={<Technology/>} loader={TechLoader}/>
